...
#include "aho_corasick_automata.hpp"
#endif
...
AhoCorasickAutomata<kAlphaLeft, kAlphaRight>::AhoCorasickAutomata()
    : is_built_(false),
      next_str_num_(0),
...
template <char kAlphaLeft, char kAlphaRight>
requires(kAlphaRight >= kAlphaLeft)
void AhoCorasickAutomata<kAlphaLeft, kAlphaRight>::addString(
    const std::string& s) {
...
template <char kAlphaLeft, char kAlphaRight>
requires(kAlphaRight >= kAlphaLeft)
[[nodiscard]] AhoCorasickAutomata<kAlphaLeft, kAlphaRight>::occurrences
AhoCorasickAutomata<kAlphaLeft, kAlphaRight>::findAllOccurrences(
...
template <char kAlphaLeft, char kAlphaRight>
requires(kAlphaRight >= kAlphaLeft)
void AhoCorasickAutomata<kAlphaLeft, kAlphaRight>::buildAutomata() {
...
template <char kAlphaLeft, char kAlphaRight>
requires(kAlphaRight >= kAlphaLeft)
AhoCorasickAutomata<kAlphaLeft, kAlphaRight>::Node::Node()
    : is_terminal_(false),
